...
import { CalendarDays, Clock3, Columns3, Library, Menu, MoreHorizontal, Pencil, Plus, Search, Settings, Trash2, X } from 'lucide-react'
...
export function Sidebar() {
  const { view, setView, posts, activeSpace, customSpaces, hiddenSpaces, setActiveSpace, addSpace, renameSpace, removeSpace } = usePlanner()
