...
export function Sidebar() {
  const { view, setView, posts, ideas, activeSpace, customSpaces, hiddenSpaces, spaceNotes, saveSpaceNotes, setActiveSpace, addSpace, renameSpace, removeSpace } = usePlanner()
