...
import { Archive, ChevronDown, ChevronUp, Clipboard, FileImage, Hash, Instagram, Lightbulb, MessageCircle, MoreHorizontal, Plus, Trash2, X } from 'lucide-react'
...
import type { ContentType, IdeaBlock, Platform, Post, PostInput, PostStatus } from '../../shared/types'
import './editor.css'
...
export function Editor({ initial, onClose }: { initial: Post | null; onClose(): void }) {
  ...
  const [tab, setTab] = useState<'content' | 'ideas' | 'preview' | 'notes'>('content')
